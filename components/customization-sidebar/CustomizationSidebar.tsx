...
export default function CustomizationSidebar() {
  ...
  return (
    <>
      ...
      <aside ref={sidebarRef} className="xl:w-1/4 xl:h-[98vh] xl:mr-3 overflow-x-hidden overflow-y-auto bg-slate-100 p-4 rounded-md shadow-xl w-[98%] m-1 xl:ml-0 h-[500px] dark:bg-slate-900" hidden={!isOpen}>
