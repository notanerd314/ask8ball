...
export const CloseIcon: React.FC<CommonProps> = ({ color = "currentColor", size = 24, className }) => (
  <svg
...
export const ShareIcon: React.FC<CommonProps> = ({ color = "currentColor", size = 24, className }) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    viewBox="0 0 448 512"
    style={{ color, width: size, height: size }}
...
export const ChevronRightIcon: React.FC<CommonProps> = ({ color = "currentColor", size = 24, className }) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    viewBox="0 0 320 512"
    style={{ color, width: size, height: size }}
...
export const RefreshIcon: React.FC<CommonProps> = ({ color = "currentColor", size = 24, className }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 512 512"
    style={{ color, width: size, height: size }}
...
export const StarIcon: React.FC<CommonProps> = ({ color = "currentColor", size = 24, className }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 576 512"
    style={{ color, width: size, height: size }}
