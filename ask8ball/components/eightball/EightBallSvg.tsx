...
export const EightBallSvg: React.FC<Props> = ({ isShaking, diceStyle }) => {
  ...
  const updateSize = () => {
    ...
    if (setDiceSize) {
      ...
      setDiceSize({ width: diceSize?.width! - (diceSize?.width / 2.5), height: diceSize?.height });
    }
  };
  ...
  return (
    ...
    >
      ...
      <circle cx="568.2" cy="453.2" r="218.8" fill="url(#a)"/>
      ...
      <path fill={isShaking ? "none" : "#fff"} stroke="#141919" strokeMiterlimit="10" d="M678 454.4c1.4-58.6-48.9-107-109.8-105.5-61-1.4-111.2 47-109.7 105.5-1.5 58.5 48.8 106.9 109.7 105.5 61 1.4 111.2-46.7 109.7-105.5z"/>
      ...
      <path fill={!isShaking ? "none" : "#303084"} style={diceStyle} ref={diceRef} stroke="#303084" d="M485 402.7c-3.1-5.7.3-10.4 8.2-10.7 50.6-1.6 107.6-1.6 157.4.3 7.6.2 11 5.2 7.9 10.6a2332.4 2332.4 0 0 1-80 131.1c-3.6 5.7-9.6 5.7-13.3 0a2645.3 2645.3 0 0 1-80.1-131.3z"/>
      <ellipse cx="570" cy="420.4" fill="#fff" stroke="#141919" strokeWidth="15" rx="36" ry="34.5" opacity={isShaking ? "0" : "1"}/>
      <ellipse cx="570" cy="489.4" fill="#fff" stroke="#141919" strokeWidth="15" rx="36" ry="34.5" opacity={isShaking ? "0" : "1"}/>
    </svg>
  )
}
