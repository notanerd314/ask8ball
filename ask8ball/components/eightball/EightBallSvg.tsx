...
export const EightBallSvg: React.FC<Props> = ({ currentState, diceStyle }) => {
  ...
  return (
    ...
    >
      ...
      <path fill={canShowResult ? "#303084" : canShowError ? "#FF0000" : "none"} style={diceStyle} ref={diceRef} stroke="transparent" d="M485 402.7c-3.1-5.7.3-10.4 8.2-10.7 50.6-1.6 107.6-1.6 157.4.3 7.6.2 11 5.2 7.9 10.6a2332.4 2332.4 0 0 1-80 131.1c-3.6 5.7-9.6 5.7-13.3 0a2645.3 2645.3 0 0 1-80.1-131.3z" />
