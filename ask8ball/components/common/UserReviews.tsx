...
export default function UserReview({ quote, author, stars }: Props) {
  return (
    <article className="relative flex flex-col p-3 text-center border-2 border-transparent shadow-lg gap-2 transition duration-300 ease-in-out rounded-md bg-slate-100 hover:border-indigo-500 hover:-translate-y-1 dark:bg-slate-900">
